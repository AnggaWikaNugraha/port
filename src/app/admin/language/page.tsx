        ...
        <div className="flex flex-col gap-4 rounded-3xl border border-gray-800 bg-gray-900/70 p-6 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.22em] text-emerald-300">
              ...
              Private Language Lab
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white sm:text-3xl">Manage Bahasa</h1>
            ...
            <div className="rounded-3xl border border-gray-800 bg-gray-900/60 p-5">
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  <select
                    value={direction}
                    onChange={(e) => setDirection(e.target.value as "all" | "en-id" | "id-en")}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <FormField label="Dari">
                  <select
                    ...
                    onChange={(e) => setForm((prev) => ({ ...prev, sourceLang: e.target.value as LanguageCode }))}
                ...
                <FormField label="Ke">
                  <select
                    ...
                    onChange={(e) => setForm((prev) => ({ ...prev, targetLang: e.target.value as LanguageCode }))}
                    className="w-full rounded-2xl border border-gray-800 bg-gray-950 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                  >
                    <option value="id">Indonesia</option>
                    <option value="en">English</option>
              ...
              <FormField label="Arti / Terjemahan">
                <textarea
                  ...
                  onChange={(e) => setForm((prev) => ({ ...prev, meaningsText: e.target.value }))}
                  rows={5}
              ...
              <FormField label="Contoh Sumber">
                <textarea
                  ...
                  onChange={(e) => setForm((prev) => ({ ...prev, exampleSource: e.target.value }))}
                  rows={3}
              ...
              <FormField label="Contoh Target">
                <textarea
                  ...
                  onChange={(e) => setForm((prev) => ({ ...prev, exampleTarget: e.target.value }))}
                  rows={3}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <FormField label="Teks Sumber">
                <textarea
                  ...
                  onChange={(e) => setDraft((prev) => ({ ...prev, sourceText: e.target.value }))}
              ...
              <div className="grid grid-cols-2 gap-3">
                <FormField label="Dari">
                  <select
                    ...
                    onChange={(e) => setDraft((prev) => ({ ...prev, sourceLang: e.target.value as LanguageCode }))}
                    className="w-full rounded-2xl border border-gray-800 bg-gray-950 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                  >
                    <option value="en">English</option>
                    <option value="id">Indonesia</option>
                ...
                <FormField label="Ke">
                  <select
                    ...
                    onChange={(e) => setDraft((prev) => ({ ...prev, targetLang: e.target.value as LanguageCode }))}
                    className="w-full rounded-2xl border border-gray-800 bg-gray-950 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                  >
                    <option value="id">Indonesia</option>
                    <option value="en">English</option>
              ...
              <FormField label="Contoh Sumber">
                <textarea
                  ...
                  onChange={(e) => setDraft((prev) => ({ ...prev, exampleSource: e.target.value }))}
              ...
              <FormField label="Contoh Target">
                <textarea
                  ...
                  onChange={(e) => setDraft((prev) => ({ ...prev, exampleTarget: e.target.value }))}
                  className="min-h-[88px] w-full rounded-2xl border border-gray-800 bg-gray-950 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                />
              </FormField>
            </div>
